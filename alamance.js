var request = require("request"),
    ...
    url = "https://www.alamancecc.edu/staff-directory/";
    ...
    if (!error){
        ...
        function getAll(){
            ...
            row.each(function(i, row){
                ...
                var thisHref = row.children[10].attribs.href;
            ...
            fs.writeFile('output/json/alamance.json', json, 'utf8');

            var fields = ['fullname', 'email']
            try {
                var result = json2csv({data: everything["content"], fields: fields})
                fs.writeFile('output/csv/alamance.csv', result, 'utf8')
            } catch (err) {
                console.error(err)
            }
